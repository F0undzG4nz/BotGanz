...
*/
const A187 = '👾FoundzBot👾'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'https://instagram.com/aditiapurna_'; // JANGAN UBAH-UBAH INFO!!!
const nomer = 'Wa.me/+6289664550953'; // JANGAN UBAH-UBAH INFO!!!
const aktif = 'Tergantung jaringan'; // JANGAN UBAH-UBAH INFO!!!
const groupwhatsapp = 'https://chat.whatsapp.com/Dy6SNvF6uKFKAhlg0ldIZw'; // JANGAN UBAH-UBAH INFO!!!
const youtube = 'https://www.youtube.com/channel/UCHL57OEnX9BwTheOpzh2LYQ'; // JANGAN UBAH-UBAH INFO!!!
//FoundzGanz
...
const foundz = require("./lib/foundz.js");
const donate = require("./lib/donate.js");
const info = require("./lib/info.js");
const foundz1 = require("./lib/foundz1.js");
const foundz2 = require("./lib/foundz2.js");
const foundz3 = require("./lib/foundz3.js");
const foundz4 = require("./lib/foundz4.js");
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] FoundzBot ready scan now!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @aditiapurna_`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @aditiapurna_`)
})
...
conn.sendMessage(id, ' *Owner FoundzBot wa.me/+6289664550953* ' ,MessageType.text);
}
else if (text == '#help'){
...
conn.sendMessage(id, ' *Creator FoundzGanz wa.me/+6289664550953* ' ,MessageType.text);
}
else if (text == 'Pagi'){
...
conn.sendMessage(id, foundz.foundz(id, A187, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
if (text == '#menu1'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, foundz1.foundz1(id, A187, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
if (text == '#menu2'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, foundz2.foundz2(id, A187, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
if (text == '#menu3'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, foundz3.foundz3(id, A187, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
if (text == '#menu4'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, foundz4.foundz4(id, A187, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
else if (text == '#donate'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾FoundzBot👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/aditiapurna_' ,MessageType.text);
}
else if (text == '#menu1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾FoundzBot👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/aditiapurna_' ,MessageType.text);
}
...
//Tolonglah bro jangan di ubah ubah FoundzGanz
